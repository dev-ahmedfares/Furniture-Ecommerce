    ...
    >
      ...
      >
        <div className="flex-1 flex flex-col gap-1">
          <div
            className={`relative  ${
              data?.productimage.length > 1 ? "h-[200px] rounded-tr-[8px] rounded-tl-[8px]" : "md:min-h-full min-h-[300px] rounded-[8px]"
          ...
          <div className="flex gap-1">
            {data?.productimage.length > 1 && (
              <div className={`flex-1 relative   background-light600_dark200 h-[160px] ${data?.productimage.length > 2 ? "rounded-bl-[8px]":"rounded-bl-[8px] rounded-br-[8px]"}`}>
                <Image
        ...
        <div className="flex-1">
          ...
          <BtnPrimary customStyle="w-full rounded-full">Add to Cart</BtnPrimary>
        </div>
      </div>
    </Loading>
  );
